              ...
              <table class="table table-bordered data-table">
                ...
                <tbody>
                  ...
                  <tr class="gradeX">
                    ...
                    <td>
                        {{ $coupon->amount }}
                        @if($coupon->amount_type=="percentage") % @else UGX @endif
                    </td>
                    ...
                    <td class="center">
                      ...
                      <a  rel="{{ $coupon->id }}" rel1="delete-coupon" <?php /* href="{{ url('/admin/delete-coupon/'.$coupon->id) }}"*/?> href="javascript:" 
                        class="btn btn-danger btn-mini deleteRecord" title="Delete Coupon" >Delete</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
